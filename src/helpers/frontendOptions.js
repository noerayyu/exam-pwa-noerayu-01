    ...
    if (pwaConfig) {
        ...
        return `
            :root {
                ...
                --color-pwa-button_background_color: ${button_background_color || COLORS.blue.DEFAULT};
                --color-pwa-button_background_hover_color: ${button_background_hover_color || COLORS.blue.DEFAULT};
                ...
                --color-pwa-button_border_color: ${button_border_color || COLORS.blue.DEFAULT};
